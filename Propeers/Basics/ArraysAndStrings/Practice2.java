...
class Practice2{
    public static void main(String[] args) {
       String sentence = "Hello i am bro i read everything";
      for(int i=0; i<sentence.length(); i++){
            ...
            if( ascii== 32){
                i++;
                sentence = sentence.substring(0,i) + sentence.substring(i).toUpperCase() + sentence.substring(i+1, sentence.length());            }
      }
